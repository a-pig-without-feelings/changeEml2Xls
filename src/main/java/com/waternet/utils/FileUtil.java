...
public class FileUtil {
    ...
    public static void changeEml2Xls(String inputPath,String outputPath) throws Exception {
        ...
        Elements expectation = parsedDoc.select("#Form1 > .JlDiv >.JlXmDiv > #jobintentiondiv.JlXmxqDiv");
        //System.out.println(":::求职意向：" + expectation.text());
        candidate.setExpectation(expectation.text());
...
//        candidate.getExpectation().setWorkNature(getLastStr(expectation.text(), "期望工作性质："));
        ...
        //03 将list对象集合输出到文件夹
        ExcelWriterUtil.writeToExcel(candidates, Candidate.class, outputPath);
